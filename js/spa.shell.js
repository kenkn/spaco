...
spa.shell = (function () {
  ...
  copyAnchorMap = function () {
    console.log("copyanchormap shell");
  ...
  setJqueryMap = function () {
    console.log("setjquerymap shell");
  ...
  // 目的: チャットスライダーの拡大格納
  // 引数:
  //   * do_extend - trueの場合，スライダーを拡大し，falseの場合は格納する．
  ...
  //     * 成功時にtrue，失敗時にはfalseを返す
  //
  changeAnchorPart = function ( arg_map ) {
    console.log("changeanchorpart shell");
    var
  ...
  //   * 提示された状態が既存の状態と異なるときのみ
  //     アプリケーションを調整する
  //
  onHashchange = function ( event ) {
    console.log("onhashchange shell");
    var
